...
namespace HelpDesk
{
    public partial class vistaReporteHistorico : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            // Redirecciona después de descargar
        ...
        protected void listClienteObra_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                TraerReporteHistorico();
            }
        }

        public void TraerReporteHistorico()
        {
            try
            {
                SqlConnection conn = new SqlConnection(connectionString);
                conn.Open();
                SqlCommand cmd = new SqlCommand("SP_TraerReporteHistorico", conn);
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                string attachment = "attachment; filename=" + listClienteObra.SelectedItem + ".xls";
                ...
                // Bandera para direccionar después de descargar
                Session["redirect"] = "1";
