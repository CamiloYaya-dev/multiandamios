<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="vistagerente.aspx.cs" Inherits="HelpDesk.vistagerente" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    --TOOLBAR FLOTANTE onload="upMenu_Load"--
    <Triggers>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            onmouseover="this.src='Toolbar/ButtonBarEditOver.gif'"
                             onclick="Modificar_Click" ToolTip="Principal" style="width: 30px" 
    ...
    <table id="AdUsuarios" cellpadding="0" cellspacing="0" border="0"             
        style="top:130px; z-index:800; width:1000px; left: 0px; height: 62px;">
        <tbody>
            <tr>
                
                <td class="style14" >
                    <b style="color: #666666; font-size: small; font-weight: normal; text-align: center;">
                    <br />
                    <br />
                    <br />
                    <br /></b>
                ...
                <td>
                    <ul class="gallery clearfix" 
                            ...
                            <li><a href="Parametrizacion/Usuarios.aspx?iframe=true&amp;width=490&amp;height=440&amp;SCROLLING=no" rel="prettyPhoto[iframe]">Crear</a></li>
                        <li><a href="Parametrizacion/ModificarUsuarios.aspx?iframe=true&amp;width=1100&amp;height=450&amp;SCROLLING=no" rel="prettyPhoto[iframe]">Modificar</a></li><%}%>
                            <li style="width: 160px">
                                <a href="Parametrizacion/Contrasena.aspx?iframe=true&amp;width=450&amp;height=200&amp;SCROLLING=no" rel="prettyPhoto[iframe]">Cambiar contraseña</a></li>
                    </ul>
                </td>
            </tr>
        </tbody>
    ...
    <%--CONTROL DE BARRA FLOTANTE <script language="javascript" type="text/javascript">
        ...
        <%--TOOLBAR FLOTANTE <div id="MenuInicial" style="height:30px; position:absolute; top:1;"> </div>                     
       ...
       <%--</ContentTemplate>
        ...
        <br />
    &nbsp;<asp:Label ID="Titulo" runat="server" Font-Bold="True" ForeColor="#6699FF">Listado de Obras</asp:Label>
    <br />
    <br />
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
            ...
            onpageindexchanging="GridView1_PageIndexChanging" PageSize="12" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Usuario" HeaderText="Obra" />
            <asp:BoundField DataField="Nombre" HeaderText="Fecha Venta" />
            <asp:BoundField DataField="Empresa" HeaderText="Fecha Vencimiento" />
        </Columns>
