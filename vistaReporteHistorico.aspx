...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server" >
    ...
    <%--CONTROL DE BARRA FLOTANTE <script language="javascript" type="text/javascript">
        ...
        <asp:Label ID="LabelReporte0" runat="server" Font-Bold="True" ForeColor="#6699FF">Reporte histórico</asp:Label>
        &nbsp;
                    <br />
            ...
            <asp:GridView ID="GridViewReporte" runat="server" AllowPaging="True" 
                    ...
                    <Columns>   
                        <asp:BoundField DataField="Codigo" HeaderText="Remisión" Visible = "false"/>  
