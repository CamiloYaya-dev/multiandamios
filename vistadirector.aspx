<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="vistadirector.aspx.cs" Inherits="HelpDesk.vistadirector" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table id="AdUsuarios" cellpadding="0" cellspacing="0" border="0"             
        style="top:130px; z-index:800; width:1000px; left: 0px; height: 69px;">
            <tbody>
                <tr>
                    <td class="style8">
                        <b style="color: #666666; font-size: small; font-weight: normal; text-align: center;">
                        <asp:ImageButton ID="List_Tecnicos" runat="server" 
                            AlternateText="Listado de Técnicos" ImageUrl="~/imagenes/Modify.png" 
                            onclick="List_Tecnicos_Click" Width="24px" />Listado de Técnicos</b></td>
                    <td class="style9" >
                        <b style="color: #666666; font-size: small; font-weight: normal; text-align: center;">
                        <br />
                        <br />
    ...
    <%--CONTROL DE BARRA FLOTANTE <script language="javascript" type="text/javascript">
        ...
        &nbsp;<asp:Label ID="Titulo" runat="server" Font-Bold="True" ForeColor="#6699FF">Listado de Tickets y/o Solicitudes por escalar</asp:Label>
        <br />
        ...
        <asp:Label ID="Label2" runat="server" Font-Bold="True" ForeColor="#CC0000" 
            Text=""></asp:Label>
        <br />
        &nbsp;<asp:Label ID="Titulo2" runat="server" Font-Bold="True" ForeColor="#6699FF">Escalados</asp:Label>
        <br />
        <br />
